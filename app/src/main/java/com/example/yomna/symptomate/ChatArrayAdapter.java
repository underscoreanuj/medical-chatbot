...
class ChatArrayAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        viewType = getItem(position).isMine();
        if (viewType == 0) {
        ...
        if (viewType == 6) {
            ...
            see_doctor = convertView.findViewById(R.id.find_doctors);
            see_doctor.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                                                                    //        lat           long
                    Uri uri = Uri.parse("geo:18.496320,73.804450?q=doctors+near+me"); // for example pass geo:75.333000,30.003030 to search for latitude = 75.333000 and longitude = 30.003030 as your default search query
